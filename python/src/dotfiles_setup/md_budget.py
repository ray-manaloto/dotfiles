...
# `.claude/skills/graphify/` is graphify's installer-generated skill (SKILL.md is
# 702 lines, over the 500 guideline) — vendored, regenerated by
# `graphify install`, never hand-edited, so budgeting it is meaningless. Same
# carve-out as the .agnix.toml and doc_refs exemptions (#310-#318 adoption).
_EXCLUDED_PREFIXES = ("plugins/", ".claude/skills/graphify/")
