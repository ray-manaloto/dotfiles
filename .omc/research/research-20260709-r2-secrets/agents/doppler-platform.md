...
`.omc/research/research-20260709-r2-inventory/report.md` and files cited below.
...
- **Runtime endpoint is exactly one host**: `https://api.doppler.com` (API base
  ...
  (`.omc/research/research-20260709-r2-web-env/agents/network-allowlist.md:138-140`):
...
2. **No service token anywhere.** Fine for the Mac host (interactive login is
   ...
   **read-only service token scoped to `dotfiles/dev`** (or a dedicated
   ...
   (`.omc/research/research-20260709-r2-web-env/agents/official-docs.md:43`) —
