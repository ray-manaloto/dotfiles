...
- [ray-manaloto/dotfiles](https://github.com/ray-manaloto/dotfiles) — grounding inventory `.omc/research/research-20260709-r2-inventory/report.md` and repo rules constraining the design (mise-tasks-only, long-running-command-hangs).
