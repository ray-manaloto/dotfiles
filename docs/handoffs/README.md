...
(which `/session-handoff` writes — gitignored, this-clone-only, for same-machine
...
|---|---|---|
| `/clear` and keep going on the **same machine** | `/session-handoff` | `.agent/plans/` (gitignored) |
