...
Enumerated rather than asserted, because a first draft of this line claimed "the sixth consecutive
`lens: none`" from memory and that is false. Measured across all ten receipts by their `Resolved:`
date: `lens: none` appears in **445, 446 and 460** — the third of ten overall, and the **third
consecutive**, since those are the three most recently resolved. A data point for
`docs/specs/ticket-bound-receipts.md`, whose reviewed denominator is therefore unchanged again.
