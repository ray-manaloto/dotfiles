...
**Correction — 2026-09-17 (#1183):** That conclusion holds only outside the
post-re-create ownership window. Docker Desktop's virtiofs can temporarily
report the workspace mount root as `0:0` while `.git` and its files remain
