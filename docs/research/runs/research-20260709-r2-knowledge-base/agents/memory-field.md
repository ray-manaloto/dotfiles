...
Grounding: `docs/research/runs/research-20260709-r2-inventory/report.md` (corpus =
`docs/research/runs/**`, `docs/research/**` incl. mintlify-cache for 16 repos,
...
- **Anthropic's own guidance** ([Effective context engineering for AI agents](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents),
  ...
  `.agent/notepad.md` + `.claude/rules/` architecture, already in place.
