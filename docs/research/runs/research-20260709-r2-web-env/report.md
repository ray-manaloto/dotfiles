...
(`docs/research/runs/research-20260709-r2-web-env/agents/{official-docs,tool-compat,network-allowlist,caching-lifecycle,roadmap-signals}.md`),
grounded on `docs/research/runs/research-20260709-r2-inventory/report.md`. All
...
- **Pre-installed**: Python 3.x with pip/poetry/**uv**/black/mypy/pytest/
  ...
  `docs/research/runs/research-20260709-r2-inventory/report.md:120-124`).
