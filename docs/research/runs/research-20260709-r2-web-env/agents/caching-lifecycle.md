...
- **Consequence:** pulling `ghcr.io/ray-manaloto/dotfiles-devcontainer:dev`
  (~38 GB; repo baseline `docs/research/runs/research-20260709-r2-inventory/
...
- [ray-manaloto/dotfiles](https://github.com/ray-manaloto/dotfiles) — repo baseline facts (image size ~38GB, AMD64 constraint) from the working tree and `docs/research/runs/research-20260709-r2-inventory/report.md`.
