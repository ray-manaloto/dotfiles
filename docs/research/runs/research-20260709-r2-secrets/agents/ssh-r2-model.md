...
`docs/research/runs/research-20260709-r2-inventory/report.md`; Run A web-env
report Read in full (`docs/research/runs/research-20260709-r2-web-env/report.md`).
...
(`docs/research/runs/research-20260709-r2-web-env/report.md:165-166`) — SSH is
