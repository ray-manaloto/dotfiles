...
`docs/research/runs/research-20260709-r2-inventory/report.md` (baseline: Doppler
...
(`docs/research/runs/research-20260709-r2-web-env/report.md`) for the web-session
allowlist model.
