...
Date: 2026-07-10. Supersedes `.agent/plans/plan-20260709-unified-image.md` (the
r1 unified-image plan). Grounded in the seven r2 domain reports and the
unified synthesis (`docs/research/runs/research-20260709-r2-synthesis/report.md`).
...
- **Layer 2 (gated pilot, Mac-only):** periodic graphify synthesis over
  `docs/research/` + `docs/research/runs/` (excluding `mintlify-cache/`), outputs
