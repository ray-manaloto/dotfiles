...
Raw captures live in `.agent/kb/raw/src-*.md`.
...
Fetched: HTTP 200, 212 KB HTML. Raw: `.agent/kb/raw/src-augmentcode-graphify-knowledge-graphs.md`
...
Fetched: HTTP 200, 161 KB HTML. Raw: `.agent/kb/raw/src-mateuszdev-graphify-for-ai-coding.md`
...
`.agent/kb/raw/src-linkedin-graphify-ollama-csharp.md`. Published **May 16, 2026**
...
Fetch: HTTP 200 both (raw.githubusercontent.com). Raw: `.agent/kb/raw/src-mlx-README.md`,
`.agent/kb/raw/src-mlx-lm-SERVER.md`. **Verbatim.**
...
Fetch: HTTP 200 both. Raw: `.agent/kb/raw/src-lmstudio-home.md`, `.agent/kb/raw/src-lmstudio-openai-compat.md`
...
Fetch: home HTTP 200 but client-rendered (grep for `1337`/`openai` over 2.4 MB of markup → **0 hits**; that is a rendering artifact, not absence). Docs page HTTP 200, 80 KB, **content confirmed**. Raw: `.agent/kb/raw/src-jan-home.md`, `.agent/kb/raw/src-jan-api-server.md`
...
Fetch: HTTP 200, 61 KB. Raw: `.agent/kb/raw/src-codersera-local-ai-model-picker.md`
