...
- Root authority in a linked worktree (Ray ruled, 2026-09-23): the roadmap lives in the
...
- Consumer cutover (Ray ruled, 2026-09-23): the dotfiles attest and pointer subcommands, their modules
...
- Worker lanes see the plan. Both spawn sites already pass no environment, so lanes inherit the session
  ...
  the dispatch record and (Ray ruled, 2026-09-23) dispatch proceeds with a warning. Never auto-attest
  at dispatch.
...
Design questions, all ruled by Ray on 2026-09-23 as recommended (the alternatives are recorded for context).
