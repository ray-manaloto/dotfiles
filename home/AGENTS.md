...
| `CLAUDE.md.tmpl`, `AGENTS.md.tmpl`, `CODEX.md.tmpl`, `GEMINI.md.tmpl` | **User-level** home agent instructions — render to `~/CLAUDE.md`, `~/AGENTS.md`, etc. Distinct from this repo's root `AGENTS.md`. |
