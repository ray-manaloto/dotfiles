...
cat > .agent/kb/raw/codex-sol-advisor-prompt.md <<'EOF'
...
cat .agent/kb/raw/codex-sol-advisor-prompt.md | PLANNING_DISABLED=1 codex exec \
  --ephemeral --sandbox read-only \
  --model gpt-5.6-sol \
  -c model_reasoning_effort="xhigh" \
  -o .agent/kb/raw/codex-sol-advisor-verdict.md -
```
